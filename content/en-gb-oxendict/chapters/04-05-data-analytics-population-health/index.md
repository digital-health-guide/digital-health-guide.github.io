...
- **Predictive theatre.** Building sophisticated models the organization has no capacity to act on, or that quietly encode bias against the populations most in need.
...
| Value & literacy | Success measured by report volume | Some usage tracking; pockets of data literacy | Products linked to decisions; literacy programme in place | Product value measured against targets; retirement and literacy managed as a governed, recurring cycle | Outcomes and value tracked; unused products retired; literacy widespread |
