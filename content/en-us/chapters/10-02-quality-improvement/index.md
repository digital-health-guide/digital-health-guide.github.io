# Chapter 10.2 — Quality Improvement & Improvement Science
...
Most NHS teams run PDSA inside the **Model for Improvement**, a framework popularized by the Institute for Healthcare Improvement (IHI) that pairs the cycle with three questions: What are we trying to accomplish? How will we know that a change is an improvement? What change can we make that will result in improvement? The first question is answered with an **aim statement** (specific, measurable, time-bound). The third is often mapped with a **driver diagram**, which links your aim to the primary and secondary drivers you believe influence it, and then to concrete change ideas.
...
1. **Are we running quality improvement, project delivery, or research — and do we know the difference?** These three modes are routinely confused, and the confusion is expensive. Project delivery aims to deliver a defined scope on time and budget; research aims to produce generalizable knowledge with rigorous controls and ethics approval; QI aims to make a local system better through iterative small tests of change. Measurement for improvement is deliberately lighter than measurement for research — you want just enough data to guide the next cycle, not a publishable study. Applying research-grade rigor to a QI test paralyses the team; applying QI informality to something that is really research risks ethical and safety failures. Talk through where each of your current initiatives genuinely sits, and whether you have the right governance for each. Getting this wrong is a frequent reason digital improvement work stalls or draws unwarranted scrutiny.

2. **How will we know a change is an improvement, and not just noise or wishful thinking?** This is the second question of the Model for Improvement, and it is where most teams are weakest. Decide now what your outcome, process, and balancing measures are, how often you will collect them, and how you will display them over time. Commit to run charts or SPC before you launch, so you are not tempted to cherry-pick a favorable before-and-after comparison afterwards. Discuss what a "special-cause signal" would look like for each measure, and who is empowered to call it. Be honest about the uncomfortable corollary: you must be willing to see that a change you invested in did not work. Link this to Chapter 1.3 — Evidence-Driven Decisions, because the same intellectual honesty underpins both.

3. **Do our frontline teams actually have permission, time, and data to improve — or only pressure to deliver?** Improvement capability is not a slogan; it requires protected time, coaching, psychological safety, and accessible data. Ask candidly whether staff feel safe reporting that a test failed, or whether they expect blame. Ask whether the data they need arrives in days and weeks rather than months, and whether your digital systems help or hinder. Consider whether your organization has genuine QI infrastructure — a faculty, a method, a measurement function — or whether improvement depends on a few enthusiasts. Discuss what your digital team could remove from the frontline's path: manual data collection, brittle spreadsheets, delayed reports. The answer usually reveals more about your culture than your technology, and it directly shapes what Chapter 10.4 — Visibility for the CEO & Senior Leaders should surface to the board.

4. **When a change works, how will we make it hold and spread — and how will we know it has not quietly reverted?** The most demoralizing QI outcome is a genuine local gain that fades within months once attention moves on, and the second most demoralizing is a success that never spreads beyond the ward that pioneered it. Discuss concretely how a proven change will be standardized and embedded — ideally in the tooling itself, through defaults and automation, rather than a laminated poster or individual goodwill that decays. Decide who owns the measure after the improvement project closes, and whether your run chart or SPC chart will keep running so a reversion shows up as a special-cause signal rather than a surprise a year later. Talk about spread as a deliberate act of adaptation, not copy-paste: what worked in one clinic must be re-tested, not merely rolled out, in settings with different staff, patients, and systems. Be honest about whether your organization actually resources sustainability and spread, or treats "closed" as "done". This is where QI meets Chapter 8.1 — Change Management, and where digital defaults are your strongest lever.

5. **Are our improvements narrowing or widening inequity — and would our balancing measures actually catch it?** Digital improvements are especially prone to lifting the average while leaving some groups behind, because the people a new online route serves least well are often the least visible in aggregate data. Decide now whether you will disaggregate your measures by the dimensions that matter — age, deprivation, language, digital confidence, disability — rather than reporting a single headline number that can hide harm. Discuss what an equity balancing measure looks like for this specific change, and who is accountable for acting when it moves the wrong way. Be candid about the trade-off: maintaining a phone route alongside a self-referral form costs money and staff, and the pressure to decommission the "old" channel once digital uptake climbs is exactly how exclusion creeps in. An honest answer names the groups most at risk for this change, states how you would detect harm early, and commits to keeping the non-digital path open until the data says it is safe to change. This connects directly to the equity duties discussed elsewhere in this book and to your obligations as a public service.

6. **What is our digital function's specific, highest-value contribution to improvement here — and where are we over-building?** It is tempting for a digital team to answer every quality problem with new software, but the biggest contribution is often industrializing measurement: turning hand-counted samples into trustworthy, near-real-time run charts and SPC charts drawn from live systems, so the learning loop shortens from months to days. Discuss where automated measurement and sensible defaults genuinely lock in improvement, versus where you would be gold-plating a problem that a simple process change already solved. Be wary of rebuilding a tool — the online form in this chapter's example — before the driver diagram has shown the tool is actually the bottleneck. Ask whether your effort is removing friction from the frontline's improvement work or adding a shiny artifact that nobody asked for. The honest answer distinguishes the one or two moves that measurably accelerate learning from the features that merely look like progress, and it keeps your team's scarce capacity pointed at the highest-leverage driver.
...
A health-tech startup rarely has a formal QI program, and does not need one — but the core discipline is directly applicable and often neglected. The Model for Improvement maps naturally onto product experimentation: an aim statement is a hypothesis, a PDSA cycle is a build-measure-learn loop, and balancing measures guard against the classic startup failure of optimizing one metric while quietly harming clinical safety or equity. The main risk is speed without measurement over time — shipping fast and declaring victory on a single week's uplift. Adopt run-chart thinking early; it is cheap and it makes your outcome claims credible to the NHS buyers and clinical partners you will eventually need. Treat psychological safety inside your small team as a competitive asset: honest reporting of failed tests is how you avoid building the wrong thing at scale.

### Small business

An established small provider — a GP practice, a community pharmacy, a care home, a domiciliary-care provider, or a single-site clinic — has real patients and ongoing operations but rarely any dedicated QI or analytics capability, and cash is tight. The good news is that the Model for Improvement scales down honestly: a practice manager and a clinician can write one aim statement, run a small PDSA cycle, and keep a simple run chart on a whiteboard or spreadsheet without buying anything. The discipline to protect is measurement over time — resist the urge to judge a change on last week's numbers, and pick two or three measures (including a balancing measure such as access for patients who cannot use online tools) that you can actually collect within the working day. Lean on what your existing clinical system already records rather than building bespoke dashboards you cannot maintain, and where a national approach like "Making Data Count" offers free conventions and templates, adopt them rather than reinventing. Your constraint is not ambition but time, so keep tests genuinely small and let a proven change become the standing workflow so it holds without ongoing effort.

### Enterprise

A large provider or supplier usually has an established QI infrastructure — a faculty, trained coaches, an improvement method, and a measurement function — sometimes running to hundreds of concurrent projects. The enterprise risk is the opposite of the startup's: bureaucratic QI that becomes a compliance ritual, with driver diagrams produced for governance rather than genuine tests of change. Your digital function's highest-value move is to industrialize measurement for improvement — automated, trustworthy, near-real-time SPC charts drawn from live systems — so improvement teams stop hand-counting and start learning faster. Guard against the enterprise habit of confusing a large transformation program with improvement; the two need different governance, as Chapter 5.2 — Program-Led Work makes clear. Sustainability and spread are your hardest problems at scale, so invest in them deliberately rather than assuming good local results propagate on their own.

### Government

National and regional bodies — NHS England, ICBs, arms-length bodies — shape QI through method, mandate, and infrastructure rather than by running tests themselves. The "Making Data Count" program is a good model: a nationally promoted, consistent approach to SPC that raises the quality of improvement conversation everywhere. The risk at this level is confusing performance management with improvement — imposing targets and ranking organizations by two-point comparisons, which SPC thinking specifically warns against because it mistakes noise for signal. Government's best contribution is to build capability and shared method broadly, protect frontline permission to improve, and resist the temptation to turn every measure into a judgment. When you set national digital standards, embed measurement-for-improvement conventions so that improvement, not just assurance, becomes the default posture.
...
- **Before-and-after theater.** Claiming improvement from two data points when a run chart would reveal ordinary variation. This is the single most common way teams fool themselves and their boards.
...
- **Confusing improvement with research or performance management.** Applying research-grade rigor that paralyses fast learning, or weaponizing improvement data as a league table that destroys psychological safety.
- **One-off gains that evaporate.** Celebrating a local success with no plan to standardize, embed, sustain, or spread it, so the system quietly reverts within months.
...
|---|---|---|---|---|---|
| Method | Ad hoc fixes; no shared improvement method | Some teams use PDSA and aim statements informally | Model for Improvement is the standard approach with driver diagrams | Method use is governed and reviewed; aims and driver diagrams are quality-assured against agreed criteria | Improvement method is embedded, taught, and adapted intelligently to context |
| Measurement | Before-and-after snapshots; anecdote | Occasional run charts, inconsistently drawn | Run charts and SPC used routinely, "Making Data Count" conventions followed | Measures are managed against explicit targets; special-cause signals are tracked and acted on through defined governance | Automated, near-real-time SPC from live systems; balancing measures standard |
| Capability & culture | Improvement depends on lone enthusiasts | Some training exists; permission is uneven | QI faculty, coaching, protected time, and psychological safety are established | Capability is tracked and resourced against a workforce plan; improvement activity and safety culture are actively monitored | Frontline-led improvement is the norm; failure is discussed openly and safely |
| Digital integration | Data hand-counted; systems hinder improvement | Dashboards exist but are reporting-only | Digital data pipelines feed improvement work directly | Data quality and pipeline reliability are assured and monitored, with controls governing access and use | Automation and defaults lock in and spread improvements reliably |
| Sustainability & spread | Gains are one-off and fade | Successes shared informally, rarely embedded | Standardization and spread are planned deliberately | Sustained gains are monitored against targets; reversions trigger review and spread is managed as a tracked portfolio | Improvements sustain and spread across the system as designed |
...
- [ ] We have a plan to sustain, standardize, and spread any change that proves to be an improvement.
