...
4. **Run triage on a predictable cadence.** Hold a short, regular triage session — often weekly — so requesters know when their item will be assessed and the queue never silts up. A fixed cadence turns "when will someone look at this?" into a knowable date, reinforcing the acknowledgment promise made at intake.
...
7. **Say no — and signpost — with respect.** A good triage declines work clearly and kindly: it explains the criteria, names the alternative (another team, an existing product, a later cycle), and records the decision. Signposting — "this belongs to the service desk," "the shared care record program already covers this" — is often more valuable than a flat refusal. The ability to decline is what makes a "yes" mean anything.
