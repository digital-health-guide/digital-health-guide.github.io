# Chapter 3.0 — User Research & Service Design
...
2. **Research the whole service, not the interface.** Map the journey end to end, including the phone call, the letter, the waiting room, and the handover between teams. Build a service blueprint so that the invisible back-stage work — the staff who re-key data, chase results, or work around a broken system — becomes visible. Most of the pain patients feel is created in the seams between organizations, which is exactly where a single screen redesign cannot reach.
...
5. **Make research ethical and safe by design.** Take informed consent seriously, explain clearly how data will be used, and let people withdraw at any time. Have a safeguarding plan for sessions with clinically or emotionally vulnerable participants, including what you will do if someone discloses risk or becomes distressed, and pay participants fairly for their time. Where research crosses into activities that require formal approval — for example involving patients as research subjects — check whether Health Research Authority (HRA) governance and ethics approval apply, and involve your Caldicott Guardian and information governance colleagues early (see Chapter 1.7 — Information Governance, Data Protection & Cyber Security).
...
8. **Design inclusively and test with assistive technology.** Inclusive research and accessible design are the same discipline seen from two ends. Test your prototypes with screen readers, magnification, keyboard-only navigation, and plain-language content, and include disabled people in your participant pool as standard rather than as a special study. Meeting the Web Content Accessibility Guidelines (WCAG) is a floor, not a ceiling; observing a real screen-reader user complete a task teaches you things a checklist never will (Chapter 1.9 — Digital Inclusion & Accessibility).

9. **Close the loop from insight to decision to product.** Research only creates value when it changes what gets built. Connect insights to the backlog so that prioritization reflects evidence of need (Chapter 5.0 — Product-Led Work), and feed research back to participants and staff so they see that their contribution mattered. Keep a visible record of "what we learned and what we changed," which protects the work when priorities are challenged and builds the organization's memory.
...
4. **Are we researching the whole service, or just the part we happen to own?** Most of the harm and frustration patients experience is manufactured in the seams — between the letter and the phone line, between primary and secondary care, between the digital front door and the human who has to re-key what it captured. Ask honestly how far your research reaches: does it stop at the edge of your screen, or does it follow the person into the waiting room, the call center, and the back-stage work of the staff who prop the service up? Discuss whether you have actually shadowed the receptionists, booking clerks, and nurses whose workarounds keep the pathway alive, because their invisible labor is usually where the real design problem sits. Be wary of a comfortable scope that matches your team's remit rather than the patient's journey, since organizational boundaries are exactly where accountability evaporates. An honest answer names the parts of the journey you cannot see and commits to a service blueprint that makes the back-stage visible, even when it implicates systems you do not control. Scoping out the seams is how a screen redesign ends up solving nothing.

5. **How do we keep participants safe, and are we treating their time and stories as a cost we owe?** Research in health and care routinely touches people who are unwell, frightened, bereaved, or in crisis, and a poorly handled session can do real harm or re-traumatize someone. Talk through your safeguarding plan before fieldwork: what you will do if a participant discloses risk or becomes distressed, who is on call, and when you will stop a session for the person's sake rather than the study's. Examine consent as an ongoing relationship rather than a signed form — people must understand how their data and words will be used and be able to withdraw at any point without penalty. Discuss payment plainly, because expecting vulnerable people to give their time for free is both extractive and skews your sample toward those who can afford to volunteer. Consider whether you are asking the same over-researched communities the same questions yet again, and what you owe them in return. An honest answer treats care, consent, and fair reimbursement as non-negotiable conditions of doing the work, not as optional polish.

6. **When the evidence collides with what leadership, a clinician, or a vendor wants, whose account wins?** Research earns its keep precisely when it delivers inconvenient findings, and that is the moment organizational gravity pulls hardest toward burying them. Discuss what actually happens on your team when a study contradicts a business case, a senior clinician's intuition, or a supplier's roadmap: is the finding examined, or is the researcher quietly encouraged to soften it? Explore how independent your researchers really are — whether they can report that the flagship product excludes the people it was meant to serve without it costing them their standing or their next contract. Name the pressures honestly, including commercial incentives, sunk cost, and the reluctance to reopen a decision that felt settled. Consider building in safeguards: findings shared raw with the wider team, a visible record of what was learned, and a route for uncomfortable evidence to reach decision-makers unfiltered. An honest answer admits where the team has previously let authority or commercial pressure override evidence, and states what it will do differently next time.
...
An established small provider — a GP practice, a community pharmacy, a care home, a domiciliary-care agency, or a single-site clinic — already serves real patients every day but rarely has a designer, researcher, or dedicated IT capability to call on. Formal user research feels like a luxury, yet these organizations hold something a startup would envy: a receptionist, a practice manager, and clinicians who talk to service users constantly and can tell you exactly where the current process breaks down. The practical move is to make that everyday contact deliberate — keep a simple log of the questions and complaints people raise, walk the journey yourself from the front door to the follow-up, and sanity-check any new supplier's product against how your most vulnerable patients actually behave rather than the demo. You must still meet the same consent, safeguarding, and accessibility duties as a large trust, so lean on shared NHS templates and standards instead of inventing your own. Choosing a system that has genuinely been designed around patients and staff, and pushing back when it has not, is the highest-leverage research decision a small provider makes.

### Enterprise

A large provider or supplier has scale, existing users, and rich data, but often has research fragmented across teams who never share what they learn. The opportunity is a genuine research operations function: a shared repository, standard ethics and consent processes, a managed participant pool, and a discipline of triangulating qualitative insight with the analytics you already hold. The risk is research theater — studies commissioned to justify decisions already taken, or personas printed on posters that no one uses. Insist that research connects to real decisions and to the backlog, and protect the independence of researchers so they can report inconvenient findings without career risk.

### Government

In UK government and the NHS, user-centered design is not optional: the NHS Service Standard and GDS service assessments require you to demonstrate that you understand users and their needs, and services are assessed against this at phase boundaries. This is a strength, because it gives researchers a mandate and a seat at the table. The obligations run deeper than compliance: public services must work for the whole population, including the most excluded, which makes inclusive recruitment and co-production a duty rather than a nicety. Work openly, publish findings where you can, and be alert to statutory duties on involvement and equality. The failure mode is treating the service assessment as a hurdle to clear rather than a genuine test of whether you have understood the people you serve.
...
- **Interface tunnel vision.** Redesigning a screen while ignoring the letters, phone lines, staff workarounds, and cross-organization handovers where the real pain lives.
- **Research theater.** Studies run to justify a decision already made, or to satisfy an assessment, with no willingness to change course.
...
|---|---|---|---|---|---|
| Evidence of need | Decisions based on assumption and opinion | Occasional research, often after build | Research precedes build; assumptions made explicit and tested | Evidence coverage and assumption risk tracked; gaps in the evidence base actively managed against agreed thresholds | Continuous discovery feeds a living evidence base; needs re-checked over time |
| Scope of design | Individual screens and forms | Journeys mapped for some services | End-to-end journeys and service blueprints, including back-stage | Blueprints kept current and their handover points measured, with pain in the seams monitored and owned | Whole cross-organization pathways designed and measured together |
| Inclusion of participants | Convenience sample of easy-to-reach users | Awareness of gaps; some outreach | Explicit quotas for excluded and vulnerable groups; assistive-tech testing | Recruitment against inclusion quotas measured and assured; representation gaps reported and corrected | Co-production with lived-experience partners embedded from discovery |
| Research operations | Ad hoc, per person | Shared templates and some ethics practice | ResearchOps function: repository, consent, safeguarding, recruitment pipeline | Repository use, consent compliance, and safeguarding controls monitored against defined standards | Repository actively used across teams; insight reuse is the norm |
| Impact on decisions | Research rarely changes anything | Findings sometimes inform the backlog | Insights linked to prioritization and fed back to participants | Research influence on decisions tracked, with each study's decision and outcome recorded and reviewed | Evidence visibly drives, and sometimes stops, investment decisions |
