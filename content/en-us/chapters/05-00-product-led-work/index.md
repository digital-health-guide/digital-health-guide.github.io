...
**Empowered team.** Cagan draws a sharp line between a "feature team" that is handed a roadmap of things to build, and an "empowered team" that is handed *problems to solve* and outcomes to achieve, and is trusted to find the best solution. Empowerment is not a license to do anything; it is accountability for results within a clear strategic frame.
...
**Product manager.** The [product management](https://en.wikipedia.org/wiki/Product_management) lead, accountable for the *value and viability* of the product: is this worth building, will people use it, does it fit the organization's strategy, regulations, and finances? In health and care this role must partner closely with clinical safety and information-governance leads, not sit above them.
...
**[Product lifecycle](https://en.wikipedia.org/wiki/Product_lifecycle).** Discovery (is there a real problem worth solving?), delivery (build it safely and well), growth and optimization (improve adoption and outcomes), and eventually sunset (retire or replace gracefully). Product-led teams own all of it, which is why they can make sensible whole-life trade-offs a project team cannot.

## Best practices

1. **Fund the team, not the project.** Move money from time-boxed project budgets to standing product budgets tied to a [value stream](https://en.wikipedia.org/wiki/Value_stream), as Mik Kersten argues in *Project to Product*. Fund a persistent team to pursue outcomes over successive planning cycles, and re-authorize funding based on demonstrated results, not on a milestone plan agreed years earlier.
...
3. **Make outcome measures explicit and clinically meaningful.** Agree a small set of outcome metrics up front, ideally as [objectives and key results](https://en.wikipedia.org/wiki/OKR) (OKRs — see Chapter 7.3). Pair every efficiency metric with a safety and an equity metric, so a team is never rewarded for speed at the cost of harm or of widening inequality.
...
8. **Align teams through strategy, not micromanagement.** Autonomy without alignment produces local optimization and chaos. A clear product vision and strategy — and, at scale, a portfolio and program frame (Chapters 5.2 and 5.3) — is what lets you empower teams safely.
...
2. **What are the two or three outcome metrics we would actually stake a team's funding on, and how do we pair each with a safety and an equity measure so we are never rewarded for speed at the cost of harm?**
   Outcomes over outputs is easy to say and hard to operationalize, because the moment a metric drives money it starts to distort behavior. A digital health team told to "reduce did-not-attend rates" can hit the number by nudging the most digitally-confident patients while quietly widening the gap for older or more deprived cohorts — so the debate has to surface which single efficiency metric each team might over-optimize, and what the paired safety and equity guardrail actually measures. Bring concrete candidates to the table (reduced medication errors, faster discharge, uptake by locality or digital-access proxy) and stress-test whether they are clinically meaningful or merely easy to instrument. Consider who owns each metric, what the baseline is, and how often it is reviewed, because an unowned or unbaselined outcome is decoration. An honest answer accepts that some outcomes we care about are slow or hard to measure, resists the pull toward vanity adoption numbers, and commits to publishing the equity measure alongside the efficiency one so the trade-off stays visible.

3. **How much real authority are we prepared to give an empowered team to change direction, and what strategic frame keeps that autonomy from fragmenting into local optimization?**
   Empowerment is the crux of the product operating model and also its most common counterfeit, because organizations relabel teams "product teams" while still handing down a fixed roadmap and measuring delivery. The genuine question is where the boundary sits: can a team pivot from a board-sponsored feature to a different solution when discovery shows it will realize the outcome better, or will clinical governance, information governance, and existing supplier contracts veto that in practice? The tension is that autonomy without alignment produces duplication and drift across an ICS, while alignment enforced as micromanagement recreates the feature factory — so the answer lies in an explicit product vision and strategy, and at scale a portfolio frame, that constrains without dictating. Consider a recent decision where a team wanted to change course and ask honestly whether the system let it. A good answer defines the decisions a team may take alone versus those needing escalation, names the strategy document that provides the frame, and is candid about where the organization currently confuses control with alignment.

4. **How do we fund and defend a durable team through the annual budget cycle, and what will we actually do when finance asks us to justify a "product" that has no fixed end date?**
   Product-led work stands or falls on money, and the machinery of NHS and public-sector finance is built for time-boxed capital bids, not rolling revenue funding tied to a value stream — so this question forces the uncomfortable operational detail behind "fund the team, not the project". The tension is that a durable team needs multi-year stability to retain scarce clinical, product and engineering people, yet the settlement it depends on is re-fought every year against capital schemes that show a tidy start and finish. Bring the real numbers: what is the standing cost of the team, which value stream it maps to, and what evidence of demonstrated outcomes would justify re-authorization versus a milestone plan agreed years ago. Consider how capital-versus-revenue accounting rules, procurement cycles, and supplier contracts either help or fight the model in your organization. An honest answer names who signs off the rolling budget, what happens to the team in a bad settlement year, and whether the organization is prepared to convert a genuine service into a product line rather than quietly defaulting it back to project bids.

5. **When product-led work meets our clinical safety and information-governance duties, are safety and governance genuinely inside the team as design inputs, or are they still gates the team races toward and negotiates around?**
   A durable, empowered team that ships continuously changes the risk picture, because every iteration is a potential clinical-safety and data-protection event rather than a single sign-off at the end of a project — so DCB0129/DCB0160 hazard work and DPIAs have to live inside the team's cadence, not bolt on at a release gate. The tension is real: embedding a clinical safety officer and an information-governance lead in every product team is expensive and those skills are scarce, so organizations are tempted to share them thinly or to treat assurance as an approval the team seeks late. That temptation is exactly what recreates the build-and-abandon failure for safety, because a team optimizing an outcome metric under delivery pressure will, without an internal safety voice, discover harm only after it reaches patients. Consider how the safety case is kept live across many small releases, who owns the hazard log, and whether governance colleagues have real influence on discovery and prioritization or merely a veto at the end. A good answer is candid about where safety is currently a gate rather than a design input, and commits to the staffing and cadence that make continuous assurance affordable.

6. **How will we keep a durable team genuinely close to under-served users so that continuous improvement narrows rather than widens digital exclusion?**
   Product-led work promises equity as a first-class outcome, but a stable team instrumenting its own product will naturally hear loudest from the users who already engage — the digitally confident, the connected, the ones who show up in the telemetry — so proximity to users can quietly become proximity to the *easy* users. The tension is that the cohorts most at risk of exclusion (older patients, people in deprived localities, those with low digital access or language barriers) are the hardest and most expensive to reach through continuous discovery, yet they are precisely the people a public health service exists to serve. Bring concrete practice to the table: which cohorts are deliberately recruited into research, how adoption is watched by locality and digital-access proxy, and what non-digital fallback exists when the digital route leaves someone behind. Consider whether the team's equity metric actually changes decisions or merely gets reported. An honest answer admits where the current research pool skews toward the easy-to-reach, names the under-served groups it is not yet hearing from, and describes the specific investment — outreach, assisted digital, telephone fallback — that keeps improvement from compounding advantage.
...
For an established small provider — a GP practice, a community pharmacy, a care home or domiciliary-care agency, a single-site clinic, or a small health-tech supplier past the startup stage — product-led work rarely means standing up a dedicated cross-functional team, because there is no spare product manager, designer or engineer to fund. Here the "durable team" is often the practice manager or registered manager plus a trusted supplier, so the discipline that matters is holding whoever configures and maintains the system to *outcomes* — fewer missed appointments, safer medicines reconciliation, better access for the frailest residents — rather than to a one-off installation. Cash is tight and ongoing, not runway-limited, so the sensible move is to buy into products that others keep alive (a well-run supplier's roadmap, a shared care record, an ICS platform) instead of commissioning bespoke builds nobody will maintain. Clinical safety and information governance still bite in full — the same DCB0160 deployment duties and DPIA obligations as a large trust — but with none of the in-house capability, which makes choosing suppliers who own their safety case a genuine product decision. The equity angle is close to home: a small provider often serves exactly the older or more deprived patients most exposed to digital exclusion, so keeping a non-digital fallback is not optional.

### Enterprise

In a large NHS trust, integrated care system (ICS), or health-tech firm, the durable-team model collides with annual capital budgeting and a project-shaped finance machine. The core work is converting standing services — the EPR-optimization team, the shared-care-record team — from stop-start projects into funded product teams with rolling budgets tied to value streams, which is a finance and governance change as much as an org-chart one. Accountability is layered across clinical governance, information governance, board assurance, and supplier contracts, so empowerment has to be paired with an explicit product strategy and portfolio alignment (see Chapter 5.3 — Enterprise Portfolio & Project Management) to stop dozens of autonomous teams optimizing locally. Scale is the enemy of proximity to users, so deliberate investment in embedded research is what keeps a large organization's teams honest.

### Government

At national scale — NHS England, DHSC, UKHSA — product-led work funds long-lived platforms (the NHS App, NHS login, national interoperability APIs) as products rather than programs, held to the GDS and NHS Service Standard and their service assessments. Funding flows through Spending Review settlements and business cases, so the hard part is sustaining stable teams across fiscal years and political cycles when the machinery around them is built for time-boxed projects. Accountability is to ministers, Parliament, and the public via the National Audit Office, and the equity duty is statutory, so outcome metrics must be paired with published population-level equity measures. The prize is reach: a single product improvement can touch tens of millions of users at once, which raises both the benefit and the cost of getting it wrong.
...
- **Outcomes with no safety or equity guardrail.** Optimizing a single efficiency metric can hide harm or widen exclusion. Fix: every outcome metric is paired with a safety and an equity measure.
- **"Empowerment" without strategy.** Teams left to invent their own direction drift and duplicate. Fix: strong product vision and strategy, and portfolio-level alignment (Chapter 5.3).
- **Applying product-led to genuinely finite work.** A one-off data-center migration or a hardware rollout does not need a perpetual team. Fix: use project-led work (Chapter 5.1) where scope really is fixed.
...
|---|---|---|---|---|---|
| Team stability | Teams assembled per project, then disbanded | Some persistent teams for flagship services | Durable teams own named products across their lifecycle | Retention and churn tracked against targets; capacity and cover actively managed | Stable teams flow work to themselves; low churn, deep domain knowledge |
| Mandate | Feature lists handed down | Mix of features and goals | Teams given problems and outcomes to solve | Outcome ownership formalized; mandates reviewed and steered against agreed targets | Teams shape strategy and are trusted with outcome ownership |
| Measurement | Success = delivered on time/budget | Some usage metrics tracked | Outcome metrics (incl. safety & equity) agreed and reviewed | Outcome KPIs tracked on dashboards; safety and equity controls assured against targets | Outcomes drive funding and steering decisions continuously |
| Funding | Annual/capital project bids | Blended project + partial standing funding | Rolling product funding tied to value streams | Rolling funding governed through quantitative outcome reviews against agreed targets | Outcome-based reauthorization; funding follows demonstrated value |
| Discovery | Requirements gathered once up front | Occasional user research | Continuous discovery with users and clinicians | Discovery cadence and cohort coverage measured and managed for quality | Instrumented product; evidence-led decisions by default |
...
- [ ] Is the team funded on a rolling basis and reauthorized on demonstrated outcomes?
...
- [ ] Is there a clear product strategy aligning autonomy to organizational goals?
