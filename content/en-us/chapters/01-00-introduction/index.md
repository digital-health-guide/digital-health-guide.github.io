...
These four pressures — safety, equity, duty, money — are why you cannot simply copy a consumer-tech playbook. You need ways of working that are agile *and* accountable, fast *and* safe, user-centered *and* population-fair.

## Core concepts

**Ways of working** operate at three levels. At the **team** level they are the daily practices: stand-ups, user research, iterative delivery, pairing. At the **organizational** level they are the operating model — how strategy becomes value streams, capabilities, funding, and decision rights (see Chapter 1.1 — The Operating Model). At the **system** level they are how independent organizations align: shared standards, interoperability, and common governance across an ICS. This book moves deliberately across all three.

**[User-centered design](https://en.wikipedia.org/wiki/User-centered_design)** means starting from the needs of the people who use a service — patients, carers, clinicians, administrators — rather than from an assumed solution. The UK [Government Digital Service](https://en.wikipedia.org/wiki/Government_Digital_Service) (GDS) and the NHS codified this in service standards: understand users and their needs before you build, and keep testing with real users throughout.

**[Agile, iterative delivery](https://en.wikipedia.org/wiki/Agile_software_development)** means getting a working service in front of real users early, learning, and adapting — rather than specifying everything up front. The NHS digital service manual is explicit that agile, user-centered ways of working reduce the risk of building the wrong thing. Agile here is a risk-management strategy as much as a delivery method.
...
6. **Design for interoperability and reuse.** Health and care data must flow safely between organizations; build to open standards ([HL7 FHIR](https://en.wikipedia.org/wiki/Fast_Healthcare_Interoperability_Resources), [SNOMED CT](https://en.wikipedia.org/wiki/SNOMED_CT)) and reuse platforms rather than re-inventing them (see Chapter 1.1's "thinnest viable platform" and Chapter 4.3 — Interoperability & Data Standards). A service that cannot share data is a silo waiting to become a risk.
...
2. **Do our teams genuinely have the full multidisciplinary skill mix — including clinical safety and information governance — sitting inside the team, or are those disciplines still bolted on as end-stage gates?**
   The chapter argues the MDT is the atom of digital delivery and that most failures trace to a missing discipline at the table, so this question tests whether that principle is real in your organization or merely aspirational. It matters because a clinical safety officer or Caldicott Guardian engaged only at go-live forces either rework or unsafe shortcuts, whereas one embedded from week one keeps a live hazard log that paces delivery. The trade-off worth surfacing is cost and scarcity: specialist clinical, legal, and IG time is genuinely limited, so "embed everyone in every team" collides with real resourcing constraints, and the team must decide where fractional or shared roles are acceptable and where they are not. Look at a current service and map who is actually in the standing team versus who is consulted as an external sign-off, and check whether the team has authority to decide within guardrails or must escalate constantly. An honest, good answer is specific about which disciplines are missing or borrowed, acknowledges the resourcing tension frankly, and proposes a concrete model — full-time, fractional, or on-call — for closing the gap without pretending scarcity away.
...
3. **When have we treated a digital service as a project with a hand-off rather than a product stewarded for its whole life, and what did that cost us in lost domain and safety knowledge?**
   Product-over-project is one of the chapter's load-bearing shifts, and this question makes the team confront where they still fund and staff for closure rather than continuity. It matters because health services are long-lived and continuously evolving; a team disbanded at the project boundary takes with it exactly the accumulated clinical and operational knowledge that keeps a service safe, and "pilot purgatory" is the recurring symptom. The real tension is financial and structural: product funding requires standing budgets and challenges the annual-bid, time-boxed model that finance and governance are built around, so this is as much a conversation about money and accountability as about delivery. Consider a specific service that went through a hand-off — trace what happened to its hazard log, its user research, and its team — and weigh that against the discipline product funding demands. A good answer identifies a concrete case, quantifies or at least characterizes the knowledge lost, and is candid about which organizational barriers (funding cycles, resourcing rules, governance structures) would have to move for persistent product teams to become the norm.

4. **Who is most likely to be excluded or harmed by the services we build, and can we point to where we designed for them first rather than last?**
   The chapter insists that equity is non-negotiable and that a service which works only for the digitally confident widens health inequalities, so this question tests whether "design for the hardest cases" is a live practice or a slogan. It matters because exclusion in health and care is not an inconvenience but a safety and access harm: the Core20PLUS5 populations, people with limited digital access, low health literacy, or no smartphone are precisely the people whose needs are greatest, and a service that designs them out concentrates harm where it is least affordable. The tension worth surfacing is that designing for the margins costs time and money up front — assisted-digital routes, accessibility to WCAG, offline and non-digital fallbacks, translation — and those costs are easy to defer when a delivery date looms and the confident majority can already use the thing. Look at a real service and ask who is in its user research sample, whether an equality and health-inequalities analysis actually shaped a design decision, and what happens to someone who cannot or will not go online. An honest answer names the specific groups at risk for this service, shows at least one concrete design choice made for them, and is candid about where the team traded inclusion away under pressure and how it would defend that trade next time.

5. **Where are we re-inventing plumbing that already exists, and where would building to open standards and reusing shared platforms actually change what we ship?**
   Designing for interoperability and reuse is one of the chapter's best practices, and this question makes the team confront the pull to build bespoke rather than reuse — the login, the notifications, the record integration that a dozen other teams have also built. It matters because in a fragmented system every re-invented component is public money spent twice and a new silo that cannot exchange data safely; conversely, building to HL7 FHIR and SNOMED CT and reusing the thinnest viable platform is what lets a service clear procurement and share data across an ICS at all. The real trade-off is that reuse means dependency: a shared platform may be slower, less tailored, or governed by someone else's roadmap, so the team must weigh the drag of a shared component against the long-term cost and risk of a bespoke silo. Examine a current build and list what is genuinely novel versus what duplicates an existing platform, standard, or open component, and check whether "we cannot reuse that" is an evidenced constraint or an untested assumption. A good answer distinguishes the parts worth building from the parts worth reusing, is honest about the maturity and governance of the platforms on offer, and commits to open standards for anything that must exchange data.

6. **How do we match the weight of our governance to the level of risk, and where is assurance currently either too heavy for low-risk change or too light for high-risk change?**
   Proportionate governance is a load-bearing idea in this chapter — high-risk clinical changes deserve deep scrutiny while low-risk content changes should not wait weeks for a board — and this question tests whether the organization calibrates assurance to risk or applies one blunt process to everything. It matters because mis-set governance harms both ways: a heavy one-size-fits-all gate makes teams batch up changes and slows the very iteration that keeps services safe, while a uniformly light touch lets a genuinely high-risk clinical change through without the clinical-safety and information-governance scrutiny it needs. The tension is that proportionality requires judgment, and judgment is uncomfortable for boards and auditors who find a single mandatory checklist easier to defend than a risk-tiered route. Look at how your last dozen changes were assured, sort them by actual clinical and data risk, and see whether the effort spent tracked the risk or the calendar. An honest answer identifies concrete examples of both over- and under-governance, proposes clear criteria for tiering change by risk, and names who holds the authority to decide the tier and to be accountable for it.

## In practice: a health & care example

An integrated care system wants to give clinicians across three acute trusts, community services, and local authority social care a **shared care record**. The old way would commission a fixed-scope program, specify every screen up front, and integrate late.
...
The same four pressures — safety, equity, duty, money — bear on every organization, but the ways of working that answer them shift with scale, funding, and accountability.

### Startup

A small digital-health company lives or dies by focus, so its ways of working are lean by necessity: one multidisciplinary team, flat decision-making, and daily contact with users. The constraint is runway, not headcount rules, so discovery is measured in weeks and evidence is gathered cheaply — a handful of clinical interviews, a clickable prototype, an honest hazard log kept by a fractional clinical safety officer. The danger is skipping safety and information-governance rigor to hit an investor milestone; the discipline that survives scrutiny is treating DCB0129 and a data-protection impact assessment as entry criteria for a pilot, not paperwork deferred until a trust asks. Interoperability from day one (FHIR, SNOMED CT) is also a commercial asset, because a startup that cannot exchange data will never clear NHS procurement.

### Small business

An established small provider — a GP practice, a community pharmacy, a care home or domiciliary-care agency, a single-site clinic, or a modest health-tech supplier past the pre-revenue stage — carries the same safety, equity, duty and money pressures as a large trust but with a fraction of the capability to meet them. Ways of working here have to be radically proportionate: there is rarely a dedicated digital or IG team, so the "multidisciplinary team" is often a handful of people wearing several hats plus a shared or outsourced clinical-safety and data-protection resource. The trap is assuming the statutory duties scale down with the organization — they do not, so DCB0129/DCB0160 clinical safety, a data-protection impact assessment, and accessibility still apply in full even when a single practice manager is accountable for all of them. The practical discipline is to lean hard on reuse rather than build: adopt accredited off-the-shelf systems, insist suppliers meet DTAC and open standards (FHIR, SNOMED CT), and use national and ICS-provided platforms so that safety, interoperability and information governance are inherited rather than reinvented on a shoestring.

### Enterprise

An NHS trust or ICS has the opposite problem: abundant process and fragmented ownership. Ways of working here are as much about *unlearning* — retiring fixed-scope program habits, standing down disband-and-rebuild project teams — as about adopting new practices. Accountability is formal and personal (a senior responsible owner, a Caldicott Guardian, board-level clinical safety sign-off), so the win is embedding those roles inside the delivery team rather than bolting them on as gates. A large health-tech or pharma supplier faces the mirror image: strong engineering maturity but distance from frontline clinical reality, which multidisciplinary teams with real clinician time exist to close.

### Government

A national or local public body — NHS England, DHSC, UKHSA, a local authority — sets the standards everyone else works to, so its ways of working ripple outward. Its accountability is to Parliament and the public, which raises the bar on transparency, spend control, and equity: a service standard, a published assurance route, and Core20PLUS5 duties are instruments of that accountability, not optional extras. The risk at this scale is designing centrally for an average citizen who does not exist and mandating a solution before understanding local need. The corrective is the same user-centered, iterative discipline as everywhere else, applied with a bias to setting open standards and reusable platforms that federated organizations can build on — governing the system, not just delivering a service.
...
|---|---|---|---|---|---|
| Teams | Roles borrowed ad hoc per project | Some MDTs, unstable membership | Standing MDTs with full skill mix incl. clinical safety | Team stability and skill-mix gaps tracked and staffed against targets | Empowered product teams, low turnover, deep domain knowledge |
| Delivery | Big-bang, fixed scope | Occasional iteration, mostly waterfall | Iterative delivery against user needs | Flow, release frequency and quality measured and managed to targets | Continuous delivery with safety keeping pace |
| Evidence | Decisions by seniority | Some data gathered, rarely used | Clinical and delivery evidence routinely inform decisions | Decision quality and outcome measures tracked and reviewed | Decisions logged, evaluated, and revisited |
| Safety & equity | Bolted on at go-live | Assessed once, late | Clinical risk and equity analysis run in parallel | Hazard closure and inequalities metrics reported and assured | Continuous hazard and inequalities monitoring |
| Governance | Heavy, one-size-fits-all | Inconsistent | Proportionate to risk | Assurance controls measured and audited against risk tiers | Adaptive, fast for low risk, rigorous for high |
