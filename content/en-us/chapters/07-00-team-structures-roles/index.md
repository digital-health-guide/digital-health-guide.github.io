# Chapter 7.0 — Team Structures, Roles & Responsibilities
...
The way you organize your teams becomes the way your services behave. **[Conway's Law](https://en.wikipedia.org/wiki/Conway%27s_law)** — that a system's design mirrors the communication structure of the organization that built it — is not a curiosity in health and care; it is a patient-safety risk. Fragmented teams produce fragmented care records, brittle integrations, and hand-offs where clinical risk hides.
...
- **Stream-aligned team** — organized around a single valuable stream of work (a service, a user journey, a product) and owning it end to end. This is the default team type; most people should be on one.
...
2. **Make most teams stream-aligned and give them end-to-end ownership.** Organize around a user's journey (e.g. "outpatient referral") rather than a technology layer (e.g. "the database team"). End-to-end ownership shortens feedback loops and stops the hand-off gaps where clinical risk accumulates.
...
4. **Which of our shared capabilities should be run as platforms consumed as-a-service, and are we actually resourcing them that way — or just relabeling a ticket queue?**
   The promise of a platform team is that stream-aligned teams self-serve an integration engine, an identity service, or a shared care record API without raising a ticket and waiting, so the whole system goes faster; the failure is calling something a "platform" while it remains an under-staffed central function that everyone still queues behind. The trade-off is real: building a capability as a genuine internal product means giving it its own team, roadmap, documentation, and users, which is a serious investment that competes with shipping user-facing features, and in a cash-limited NHS setting that investment is easy to defer indefinitely. In health and care the stakes are sharper because the shared capabilities are often the safety-critical ones — the person-matching index, the FHIR interfaces, the audit trail — where a thin platform team becomes a single point of failure for every service on top of it. Look at the capabilities several teams already depend on and ask, for each, whether the interaction is truly low-friction X-as-a-service or a disguised collaboration with hidden waits. An honest answer names which capabilities genuinely warrant platform investment now versus later, is clear about who funds and staffs them, and resists the temptation to declare a platform that has no product owner, no roadmap, and no self-service path.

5. **Where are we relying on contracted suppliers or borrowed staff, and which roles must we keep in-house to stay an intelligent client rather than a hollowed-out one?**
   Much digital delivery in health and care is contracted out, and a supplier can bring capacity and specialism fast — but if the product ownership, technical assurance, and clinical safety sign-off all leave the building with the contract, the organization loses the ability to judge what it is being sold, specify what it needs, or safely own the result. The tension is between speed and capability: staff-augmentation and turnkey builds get something live quickly, yet they can quietly erode the in-house muscle that lets you hold a supplier to account, and they often deliver component-shaped, hand-off-heavy structures rather than stream-aligned teams that own an outcome. In this domain the non-negotiable retained roles cluster around accountability that cannot be delegated — the Senior Responsible Owner, the Clinical Safety Officer who signs off go-live, the product owner who decides priorities, and enough technical assurance to inspect what suppliers build. Examine your current delivery and ask which capabilities you could not reconstitute if a supplier walked away tomorrow. A good answer distinguishes work that is genuinely fine to contract from the intelligent-client core that must stay in-house, insists that contracted teams are held to outcome ownership rather than body-shop staffing, and names the safety and governance decisions that must always rest with your own accountable people.

6. **How will we know our team structure is actually producing fast, safe flow of value — and what would trigger us to redraw it?**
   Team design is a means, not an end: the point of stream-aligned teams, platforms, and named interaction modes is faster, safer delivery of value, yet organizations rarely instrument whether the structure is delivering that, so reorganizations happen on politics and intuition rather than evidence. The difficulty is choosing signals that reflect flow and safety without gaming them — raw velocity or story-point throughput invites the wrong behavior, while flow metrics (lead time from idea to live, deployment frequency, hand-off count per change) and safety indicators (how quickly hazards are closed, whether teams own their own safety case) tell you more about whether boundaries are helping or hurting. There is a real tension with stability: constant reorganization destroys the team longevity and shared cognitive space that make delivery safe, so you need a high bar and clear triggers before you redraw boundaries. Discuss what evidence would tell you a boundary is wrong — persistent cross-team waits, a safety case no single team owns, a platform nobody self-serves — and who is empowered to act on it. An honest answer commits to a small set of flow-and-safety signals you will actually watch, sets a deliberate threshold that protects team stability, and names the trigger conditions and the decision-maker for any future reshaping.
...
An established small provider — a GP practice, a community pharmacy, a care home, or a single-site clinic — has real patients and ongoing operations but rarely a dedicated digital or IT team, so there is no "team topology" to design; the practice manager or a clinical lead is effectively the whole delivery capability alongside their day job. The realistic move is not to build platform and enabling teams but to name responsibilities explicitly on the people you already have — who is the Clinical Safety Officer for the systems you deploy, who owns information governance, who signs off a change — even if those are part-time hats on a handful of staff. Because the same statutory duties (DCB0129/0160, UK GDPR, accessibility) apply as they do to a large trust, the practical pattern is to lean on your suppliers' and your ICS's shared platforms and enabling support rather than reinvent them, while retaining just enough intelligent-client capability to hold suppliers to account. The single biggest risk is the one-person bottleneck: if the only person who understands the clinical system leaves, both safety and continuity walk out with them, so writing down the RACI and cross-training a second person matters more here than any formal team model.

### Enterprise

A large NHS trust or health-tech firm has the opposite problem: too many teams, drawn along legacy component and departmental lines, with hand-offs everywhere. This is where a deliberate team-design model earns its keep — reshaping component teams into stream-aligned ones, standing up platform teams for shared care-record and integration capabilities, and using enabling teams to spread scarce clinical-safety and accessibility expertise. RACI and explicit decision rights become essential because the sheer number of stakeholders makes informal coordination impossible. The Inverse Conway Maneuver is a live lever here: a decades-old org chart is already shaping the architecture, so leaders must redraw team boundaries intentionally rather than let the structure design the care record for them.

### Government

A national body (NHS England, DHSC) or local authority sets the standards others staff against — the Government Digital and Data capability framework, the Service Standard, DCB0129/0160 — and is accountable to Parliament and the public for how money buys team capacity. Structures here are shaped by procurement and funding rules: much delivery is contracted to suppliers, so the crucial roles to retain in-house are the intelligent-client ones (product ownership, technical assurance, clinical safety sign-off) that prevent capability being hollowed out. Accountability is formal and auditable — a named Senior Responsible Owner, published spend controls, transparency duties — so responsibility models are a matter of public record, not optional hygiene. The characteristic risk is that structure ossifies into permanent program boards and gates that throttle flow; the countermove is to hold suppliers to stream-aligned, outcome-owning teams rather than staff-augmentation body-shops.

## Common failure modes

- **The component team trap.** Teams split by technology layer ("front-end team", "database team") create hand-offs on every feature and own no outcome. Reorganize around streams of value.
...
|---|---|---|---|---|---|
| Team shape | Split by technology component; hand-offs everywhere | Some cross-functional teams, still dependency-heavy | Stream-aligned teams own services end to end | Team-shape health tracked against flow metrics; hand-offs and boundaries reviewed on a cadence | Team boundaries deliberately shape architecture (Inverse Conway) |
| Multidisciplinary staffing | Roles borrowed ad hoc from silos | Core roles present, clinical/IG part-time | Full MDT incl. named CSO with authority | Staffing gaps measured against a capability baseline and actively resourced to target | Teams self-assess and fill capability gaps proactively |
| Interaction clarity | Undefined; escalation by relationship | Some processes, still ticket queues | Interaction modes named per dependency | Dependency friction and wait times measured; SLAs and interfaces managed against targets | Modes reviewed and evolved; low-friction platforms dominate |
| Responsibilities | Unclear who decides | RACI exists on paper | RACI live and used for key decisions | Decision throughput and sign-off delays tracked; accountability assured through audit | Decision rights continuously tuned to reduce delay |
| Cognitive load | Overloaded teams, safety confidence low | Load recognized but not managed | Domains bounded to team capacity | Load quantified against explicit thresholds and governed as a managed metric | Load actively monitored; teams split before overload |
...
*See also Chapter 7.2 — Workforce Planning, Chapter 7.3 — Workforce Strategy, Chapter 7.5 — People & Organisational Development, and Chapter 8.1 — Change Management.*
