# Chapter 1.3 — Evidence-Driven Decisions
...
**The [hierarchy of evidence](https://en.wikipedia.org/wiki/Hierarchy_of_evidence).** [Evidence-based medicine](https://en.wikipedia.org/wiki/Evidence-based_medicine) ranks study designs by how well they control bias: at the top, [systematic reviews](https://en.wikipedia.org/wiki/Systematic_review) and [meta-analyses](https://en.wikipedia.org/wiki/Meta-analysis) of [randomized controlled trials](https://en.wikipedia.org/wiki/Randomized_controlled_trial) (RCTs); then individual RCTs; then cohort and case-control studies; then case series; and at the base, expert opinion and anecdote. The hierarchy is a guide, not a straitjacket — but it disciplines you to notice when a claim rests on anecdote dressed as proof.
...
**[A/B testing](https://en.wikipedia.org/wiki/A/B_testing) and analytics.** For lower-risk, delivery-side questions (which wording increases appointment attendance? which flow reduces drop-off?), controlled online experiments (A/B tests) give fast, causal delivery evidence. They are powerful for optimization but must never be used to make unassessed clinical changes, and must respect consent and information-governance boundaries.
...
5. **Experiment on delivery questions; evaluate clinical ones.** Use A/B testing and analytics freely for delivery optimization (wording, flow, prompts), within information-governance and consent limits. Reserve formal evaluation (trials, pragmatic studies) for questions of clinical effect. Route each question to the right method.
...
3. **How safe is it, culturally, to ask the most senior person in the room "what's the evidence?" — and when did we last treat a leader's hunch as a hypothesis to test rather than a decision?**
   This question confronts the HiPPO failure mode directly, where the highest-paid person's opinion overrides evidence, and tests whether your stated commitment to evidence survives contact with hierarchy and the vendor demo that impressed a respected director. It matters because in health and care a demo-driven decision to deploy an unassessed tool is not a commercial gamble but a clinical-safety and public-money risk, and the moment challenge becomes unsafe is the moment evidence stops governing decisions. The real tension is that psychological safety cannot be mandated by policy; it is built by senior leaders visibly inviting challenge, framing their own views as hypotheses, and pre-committing to what evidence would change their mind — behaviors that feel exposing and are easy to skip under time pressure. Ground the conversation in specifics: recall a recent decision driven more by seniority or enthusiasm than data, and ask whether anyone challenged it, whether that felt safe, and what a decision record would have captured. A good answer is candid about where hierarchy currently wins, names concrete behaviors leaders will adopt to make challenge normal, and pairs the cultural commitment with the lightweight decision log that makes reasoning auditable and prevents the same argument being re-run.

4. **For the technologies that learn or persist — our AI, our algorithms, our long-lived services — how would we actually know if their performance had drifted since we validated them, and who is watching?**
   The chapter is explicit that a one-off trial cannot capture the ongoing behavior of technologies that learn or change, and that "one-and-done evaluation" is a named failure mode whose antidote is real-world evidence and ongoing monitoring. This question matters because the danger is silent: an AI deterioration model or triage algorithm can degrade as case-mix, coding practice, or upstream data pipelines shift, and unlike a broken feature nothing obviously fails — the tool keeps producing plausible outputs while its false-alert or miss rate quietly worsens. The tension to surface is that monitoring is unglamorous and unfunded relative to the excitement of deployment: once a business case is signed and benefits are booked, few organizations resource the prospective observational work, the drift metrics, or the named owner who reviews them. Pick one live AI or algorithmic tool and trace its post-deployment life concretely — what routine data is being watched, against what baseline, at what cadence, and who would escalate a degradation and to whom. An honest answer admits where validation stopped at go-live, distinguishes the tools that genuinely need continuous surveillance from those that do not, and commits to a named owner, a metric, and a review rhythm rather than a vague intention to "keep an eye on it".

5. **When a decision we make today is questioned in two years — by a new director, a regulator, or the public — what will the written record actually show, and would it survive that scrutiny?**
   The chapter treats the decision record as core infrastructure: a lightweight log of the decision, the options, the evidence weighed, who decided and when, valued because it makes reasoning auditable, survives staff turnover, and stops the same argument being re-run every quarter. This question matters because health and care decisions attract regulatory, parliamentary, and public scrutiny in a way commercial ones rarely do, and the worked example in this chapter turns on exactly this — two years on, a new director questions a deployed tool and "the record answers". The real tension is between the discipline's tiny per-decision cost and the chronic pressure to skip it: writing down why you decided feels bureaucratic in the moment, and the people who most need the record are future staff who are not in the room to demand it. Test it against reality by trying to reconstruct the reasoning behind a significant choice made twelve or eighteen months ago — can you find what evidence was weighed and what alternatives were rejected, or only that a decision was made? A good answer confronts whether records are genuinely kept for significant decisions or only for the easy ones, whether they capture evidence and options rather than just conclusions, and whether anyone ever reads them back — because an unread, conclusion-only log is auditing theater, not institutional memory.

6. **Whose data trains and validates our evidence, and are we confident it would not entrench inequity — or are we treating data ethics as a form to sign rather than a design constraint?**
   The chapter insists that evidence work runs on patient data and that lawfulness, consent, proportionality, and fairness are design constraints, not paperwork, warning specifically against biased datasets that entrench inequity and against "ethics as paperwork" as a failure mode. This question matters because a technology validated on an unrepresentative population can perform worse for the groups already least well served — a deterioration or diagnostic model trained where certain ethnicities, ages, or comorbidities are under-represented can carry that bias into every future decision, and at national scale an endorsed dataset entrenches that inequity system-wide. The tension is that fairness analysis is harder and slower than a headline accuracy figure: it demands you interrogate who is in the data and who is missing, disaggregate performance across subgroups, and sometimes accept that your evidence is weaker for the populations you most need to serve. Make it concrete by taking a recent or proposed tool and asking whose records it was built and tested on, whether performance was ever examined by subgroup, and whether the information-governance sign-off engaged with fairness at all or merely confirmed lawful basis. An honest answer separates genuine ethical scrutiny from box-ticking, admits where representativeness was never checked, and treats bias and fairness as questions the evidence itself must answer rather than a compliance step bolted on at the end.
...
Everyone owes the same duty to match evidence to risk, but the resources, incentives, and accountability around evidence differ sharply by organization.
...
An established small provider — a GP practice, a community pharmacy, a care home, a single-site clinic, a small health-tech supplier past the startup stage — carries the same duty to match evidence to risk but has real patients, tight cash, and little or no dedicated digital capability to do it with. The realistic move is to lean on evidence others have already produced rather than generate your own: use the NICE ESF tier and DTAC assessment of a candidate tool as ready-made proportionality, ask suppliers for the tier-appropriate clinical effectiveness evidence, and refuse to be talked into an unassessed product by a slick demo. Delivery evidence is where a small organization genuinely can lead, because it sees its own patients closely — a few weeks of honest observation about whether staff actually use a tool and whether it reduces failure demand is real-world evidence within reach. A one-line decision record — what we chose, what evidence we saw, who decided — costs a small team almost nothing and protects it when a partner leaves or a CQC inspector asks why. The trap to avoid is assuming that being small exempts you from the evidence bar; the duty to patients is identical, only the resources are not.
...
|---|---|---|---|---|---|
| Basis of decisions | Seniority / demos (HiPPO) | Some data consulted | Evidence routinely required, tiered to risk | Evidence bar tracked and assured against risk tiers | Pre-committed evidence thresholds; hunches tested |
| Clinical vs delivery | Conflated or one ignored | Both mentioned | Both demanded and distinguished | Both measured against defined thresholds | Both continuously monitored |
| Evaluation | None or after the fact | Occasional, ad hoc | Logic models + proportionate designs | Evaluations governed, with KPIs tracked to target | RWE and ongoing evaluation embedded |
| Data ethics | Afterthought | Compliance-only | Ethics designed in | Fairness metrics reviewed against thresholds | Fairness and bias actively monitored |
| Decision records | None | Inconsistent notes | Standard decision log | Log completeness measured and assured | Logs reused, audited, and learned from |
