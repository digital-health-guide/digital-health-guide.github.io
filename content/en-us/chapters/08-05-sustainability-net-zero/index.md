...
**Emission scopes.** Standardized carbon accounting, most commonly the [GHG Protocol Corporate Standard](https://en.wikipedia.org/wiki/GHG_Protocol_Corporate_Standard), divides emissions into three scopes. Scope 1 is direct emissions from sources you own or control. Scope 2 is indirect emissions from the electricity, heat, and cooling you buy. Scope 3 is everything else in your value chain — suppliers, cloud providers, staff travel, procured devices, and the disposal of what you throw away. For digital services, Scope 3 usually dominates, which is why procurement and supplier behavior matter so much.

**Carbon footprint.** A [carbon footprint](https://en.wikipedia.org/wiki/Carbon_footprint) is the total greenhouse gas load attributable to an activity, product, or organization, usually expressed in tonnes of carbon-dioxide equivalent. For a digital service, the footprint spans the manufacture and disposal of hardware, the energy consumed running it, and the network and [data center](https://en.wikipedia.org/wiki/Data_center) capacity behind it. Cloud does not make emissions disappear; it relocates them to a provider whose energy mix and efficiency you should still ask about.

**Green computing and sustainable ICT.** [Green computing](https://en.wikipedia.org/wiki/Green_computing) — sometimes called green software or sustainable information and communications technology (ICT) — is the practice of designing, running, and disposing of digital systems to minimize their environmental impact. It ranges from efficient code and right-sized infrastructure to renewable-powered hosting and hardware longevity.
...
4. **How long should we keep devices in service, and what stops us from extending their life?** The embodied carbon locked up in manufacturing a laptop, tablet, or monitoring device usually dwarfs the energy it burns in use, so a longer refresh cycle is one of the highest-leverage moves available — yet the pressures pushing the other way are real. Security teams worry about unsupported operating systems, clinicians need devices that perform, and managed-service contracts are often written around a default three- or four-year swap-out. The tension to work through is embodied carbon versus supportability and risk: keeping kit too long can create clinical-safety and cyber exposure, while binning it too soon wastes carbon and money. A good answer sets refresh cycles by evidence rather than habit, distinguishes devices that genuinely must be retired from those merely assumed to be obsolete, and builds repair, refurbishment, and certified reuse into hardware and managed-service contracts. It should also confront where end-of-life kit actually goes, because informal export or landfill quietly undoes the circular story you tell yourself.

5. **Who owns our carbon numbers, and do they live on an operating dashboard or only in an annual report?** Sustainability that surfaces once a year in a glossy publication changes almost nothing; carbon only moves when it sits in the same forums, dashboards, and objectives that govern delivery and finance. The hard question is accountability: is there a named owner with the authority to change decisions, or is sustainability everyone's aspiration and no one's job? The trade-off to surface is attention and competition for it — a live carbon metric competes with cost, waiting times, and safety for scarce management focus, and will lose unless it is deliberately given standing. A good answer names an owner, puts a small, honest set of measures into the OKRs and KPIs reviewed alongside operational performance (see Chapter 10.0), and describes the forum where a bad trend actually triggers action. It should be candid about how carbon will be weighed when it conflicts with other priorities, rather than pretending such conflicts never arise.

6. **When the lower-carbon option costs more or is harder to deliver, how will we make that trade-off — and who decides?** Sustainability is easy to endorse in the abstract and awkward in the specific, because the greener choice sometimes carries a higher price, a longer timeline, or a delivery risk. If you never name those moments, the default — cheaper, faster, higher-carbon — wins silently every time, and your net-zero commitment becomes rhetoric. The tension is transparency versus convenience: burying the carbon cost of an option keeps the business case tidy but removes the decision from the people accountable for it. A good answer folds carbon explicitly into options appraisals alongside cost, benefit, and risk (see Chapter 6.0), states honestly where the low-carbon route costs more up front, and puts the choice in front of decision-makers rather than pre-empting it in a spreadsheet. It should also say who holds the pen — whether a delivery lead can quietly trade carbon away, or whether that decision is escalated and recorded.

## In practice: a health & care example

An integrated care system (ICS) is rolling out a remote monitoring service for patients with heart failure across a largely rural region. The clinical case is strong: earlier detection of deterioration, fewer emergency admissions, and patients kept safely at home. The program director, aware of the ICS Green Plan, insists sustainability is assessed from the start rather than retrofitted.
...
An established small provider — a GP practice, a community pharmacy, a care home, a single-site clinic, or a small health-tech supplier past the startup stage — carries the same duties as a large trust but with none of the spare capacity, no dedicated sustainability or IT function, and cash that is already committed to running the service. The realistic approach is to concentrate on a few high-leverage, low-effort moves rather than a full carbon-accounting program: extend device refresh cycles and buy refurbished where safe, switch to a renewable energy tariff and a greener hosting or cloud region, turn off idle kit, and route old equipment to certified reuse instead of the skip. When a bigger NHS partner or commissioner asks for a carbon-reduction plan, produce a short, honest one sized to the organization rather than copying an enterprise template you cannot sustain. Lean on shared resources — federation, primary care network, integrated care board, or trade-body guidance and emission factors — so you are not inventing the method alone. Done this way, sustainability lowers running costs as often as it raises them, which matters most when margins are thin.

### Enterprise

A large NHS trust or health-tech firm has a sprawling estate, thousands of devices, legacy data centers, and a long supply chain, so its footprint is large and its Scope 3 dominant. The work is systematic: baseline emissions across all three scopes, publish a Green Plan with owners and milestones, rationalize and decarbonize infrastructure, extend device refresh cycles, and use procurement scale to demand carbon-reduction plans from suppliers. The hard part is governance — making sustainability a standing item alongside finance and delivery rather than a separate annual report, and resisting the internal pressure to claim savings that do not net out. Enterprises also have the leverage, through contract volume, to shift whole markets toward greener defaults.

### Government

A national body such as NHS England or the Department of Health and Social Care sets the ambition, the standards, and the accountability that everyone else operates within — the net-zero targets, the requirement for supplier carbon-reduction plans, and the reporting expectations. Its challenge is coherence and honesty at scale: setting targets that are stretching yet credible, avoiding the political temptation to overstate progress, and equipping local organizations with practical tools, emission factors, and guidance rather than mandates alone. Government also holds the biggest procurement lever in the country and can decarbonize supply chains faster through commercial policy than through exhortation. Consistency between national rhetoric and the funding and rules that reach the front line is what earns public trust.

## Common failure modes

- **Measuring only IT, ignoring the system.** Optimizing your data center while missing the millions of patient miles your service could displace means you count the small savings and miss the large ones.
...
- **Offsets as a fig leaf.** Buying cheap credits to declare "carbon neutral" while emissions keep rising is greenwashing, not decarbonization.
...
- **Sustainability as an annual report, not an operating metric.** Carbon that never appears on a live dashboard or in a governance forum does not change behavior.
...
|---|---|---|---|---|---|
| Measurement | No carbon data; claims are anecdotal | Partial estimate of energy or IT only | Baseline across Scopes 1–3, reviewed annually | Carbon tracked against targets with data quality assured and trends reviewed regularly | Live carbon data integrated with delivery and finance metrics |
| Design | Sustainability considered after go-live, if at all | Ad hoc green choices by individual teams | Carbon assessed in business cases and service design | Design carbon measured against thresholds, with rebound quantified and sign-off gated on it | Low-carbon and circular design is the default, with rebound accounted for |
| Procurement | Price-only scoring | Occasional social-value questions | Social Value Act applied; carbon-reduction plans required of key suppliers | Supplier carbon performance monitored against plans, with evidence assured and non-compliance escalated | Supplier decarbonization actively managed and verified across the value chain |
| Devices & e-waste | Default refresh; landfill disposal | Some recycling in place | Extended life cycles and certified reuse/recycling | Device longevity and reuse rates tracked against targets, with disposal chains audited | Circular-economy loops with reissue, repair, and material recovery |
| Governance | No owner; no reporting | Sustainability lead exists but is siloed | Named owner; targets in objectives; regular review | Performance managed against KPIs in delivery and finance forums, with controls assured | Transparent public reporting including shortfalls; board-level accountability |
